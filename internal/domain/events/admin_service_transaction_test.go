...
type mockTransactionalRepo struct {
	...
	stripRetiredDupWarningsFunc                     func(ctx context.Context, reviewID int32, retireULIDs []string) (bool, error)
...
func (m *mockTransactionalRepo) StripRetiredDupWarnings(ctx context.Context, reviewID int32, retireULIDs []string) (bool, error) {
