...
**Note**: This guide focuses on Artsdata integration specifically. SEL also integrates with other knowledge graphs (Wikidata, MusicBrainz, ISNI, OpenStreetMap). For the complete multi-graph integration strategy, see [Knowledge Graph Integration Strategy](./knowledge-graphs.md).
