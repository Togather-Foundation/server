...
**Related Documents:**
- [SEL Schema Design](./togather_schema_design.md)
- [SEL Interoperability Profile](./togather_SEL_Interoperability_Profile_v0.1.md)
...
See [Schema Design § 5.1](./togather_schema_design.md#51-knowledge-graph-authorities-registry) for the complete `knowledge_graph_authorities` table definition.
...
Events are categorized by `event_domain` field (see [Schema § 1.1](./togather_schema_design.md#11-events-table)):
...
1. Use field-level provenance tracking (see [Schema § 3](./togather_schema_design.md#3-provenance-and-source-tracking))
